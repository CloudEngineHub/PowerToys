...
namespace Microsoft.PowerToys.UITest
{
    public static class VisualAssert
    {
        ...
        private static string GetTempFilePath(string scenario, string prefix, string extension)
        {
            string tempFileFullName = string.Join(string.Empty, scenario, "_", prefix, "_", Guid.NewGuid().ToString(), extension);
